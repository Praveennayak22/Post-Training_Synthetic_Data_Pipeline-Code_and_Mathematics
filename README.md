...
| [Pipeline Comparison](README_COMPARISON_ANALYSIS.md) | Detailed comparison of all pipelines |
...
Each pipeline may have its own license. See respective directories for details.
